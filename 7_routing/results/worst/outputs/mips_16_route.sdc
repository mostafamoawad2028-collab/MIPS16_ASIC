################################################################################
#
# Design name:  mips_16_route
#
# Created by icc2 write_sdc on Tue Sep 15 07:05:55 2026
#
################################################################################
...
# -origin user
set_clock_latency 5.01646 [get_clocks {fun_clk}]
# Set propagated on clock sources to avoid removing latency for IO paths.
set_propagated_clock  [get_ports {fun_clk}]
set_clock_uncertainty 0.45 [get_clocks {fun_clk}]
set_clock_transition 0.526989 [get_clocks {fun_clk}]
# /mnt/hgfs/VM_shared/ITI/ASIC_mips_16/syn/results/worst/outputs/mips_16.sdc, \
#   line 12
...
set_max_transition 1 [get_clocks {fun_clk}] -clock_path
