...
`include "alu.v"
`include "Mux2x1.v"
 module mips_16( input fun_clk, fun_reset, 
		 input scan_clk, scan_reset ,test_mode,   
                 output[15:0] pc_out, alu_result
   );  
 // --dft specs -- //  
 wire clk,reset ; // output from mux
...
// PC   
 ...
 // control unit  
 control control_unit(.opcode(instr[15:13]),.reg_dst(reg_dst)  
